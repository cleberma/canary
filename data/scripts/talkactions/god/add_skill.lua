		--Enhanced SKILL Modifier System by Clebin, OTBR 2025
			--(Using https://deepwiki.com/opentibiabr/canary and other AI's you can do big without knowing how to code like I did here only knowing very little programming logic).
...
-- Function to handle additive skill increase (+X levels), preserving percentage
...
-- Function to handle additive magic level increase, preserving percentage
